...
class CardSelectorCollectionView: UICollectionViewController {
    ...
    private func setUpDefaultCardCallenges() {
        ...
        self.cards = [CardChallenge.init(), CardChallenge.init(), CardChallenge.init()]
    }
    ...
    */
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(reuseIdentifier, forIndexPath: indexPath) as! CardChallengeCollectionViewCell
    
        let cardChallenge = self.cards[indexPath.row]
        
        cell.setCardTitleAndDescription(cardChallenge.challengeName, description: cardChallenge.challengeDescription)
